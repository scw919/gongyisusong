...
class ClueDiscoveryDetail extends React.Component {
    state = {
        // 文件列表
        filesList: [
            { name: '1.附件名称.png', type: 'png', size: '2.8M', url: detailInfo },
            { name: '2.附件名称.dox', type: 'word', size: '2.8M', url: detailInfo },
            { name: '3.附件名称.mp4', type: 'video', size: '2.8M', url: detailInfo },
            { name: '4.附件名称.pdf', type: 'pdf', size: '2.8M', url: detailInfo },
        ]
    }
    render() {
        return (
