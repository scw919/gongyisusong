...
const config = {
        ...
        items: [
            {
                key: 'serviceCode',
                label: '服务编码',
                render: (form) => <Input placeholder="请输入内容" />,
            },
            {
                key: 'serviceName',
                label: '服务名称',
    ...
    list: {
        ...
        listApiInterface: (query) => api.getServiceList(Object.assign(query, { servcieName: query.serviceName })), //处理字段名
        // 删除按钮的后台接口函数，其必须内部返回Promise
        deleteApiInterface: (data) => api.deleteService({ id: data.id }),
